...
class PosttagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create posttag" do
    assert_difference("Posttag.count") do
      post posttags_url, params: { posttag: { post_id: @posttag.post_id, tag_id: @posttag.tag_id } }
    end
  ...
  test "should update posttag" do
    patch posttag_url(@posttag), params: { posttag: { post_id: @posttag.post_id, tag_id: @posttag.tag_id } }
